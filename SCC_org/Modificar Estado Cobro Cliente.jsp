...
<html>
    <head>
        ...
        <script>
            ...
            function Retornar() {
                location.href = "Agregar Estado Cobro Cliente.jsp";
            }
        </script>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Modificar Estado de Cobro del Cliente</p>
                        <div id="fondotabla">
                            <div id="contenedorforma">
                                ...
                                <form id="forma" method="POST" onsubmit="return jQuery(this).validationEngine('validate');">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="nombre_estado" type="text" value="<%= request.getParameter("Nombre")%>" class="validate[required] text-input input-large" maxlength="50">
                                </div>
                                </br>
                                </br>
                                Descripción:<textarea name="descripcion" cols="" rows="" maxlength="50" placeholder="Descripción"><%= request.getParameter("Descrip")%></textarea>
                                </br>   
                                </br>
                            ...
                            <%
                                if (request.getParameter("btn_modificar") != null) {
                                    ...
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("UPDATE estado_cobro SET Nombre=?,Descripcion=?,Estado=? WHERE ID=?");
                                        ...
                                        if (ps.execute() == false) {
                                            ...
                                            out.print("<script>location.href = 'Agregar Estado Cobro Cliente.jsp';</script>");
                                        }
                                        ps.close();
                                        conn.close();
                                    } catch (Exception ex) {
