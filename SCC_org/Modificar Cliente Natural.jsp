        ...
        <script>
            ...
            jQuery(document).ready(function() {
                ...
                $('[name="check"].checkbox').click(function() {
                    ...
                    if (chk == true) {
                        location.href = "Detalle Cobro.jsp?IDOC=" + oc + "&Tip=1" + "&IDCon=<%= request.getParameter("ID")%>";
                    }
                });
                ...
                if (tipousuario != "ADMINISTRADOR") {
                    ...
                    $('#pn').prop("readonly", "readonly");
                    $('#pa').prop("readonly", "readonly");
                    $('#sn').prop("readonly", "readonly");
                    $('#sa').prop("readonly", "readonly");
            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Modificar Contrato Cliente Natural</p>
                        <div id="fondotabla">
                            <div id="contenedorforma">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("SELECT * FROM cliente_natural WHERE IDCliente=?");
                                        ...
                                        while (set.next()) {
                                            ...
                                            PreparedStatement ti = conn.prepareStatement("SELECT Tipo FROM identificacion i,cliente_natural cn"
                                                    + " WHERE cn.IDCliente=? AND cn.IDENTIFICACION_ID=i.ID");
                                ...
                                <div class="input-prepend">
                                    ...
                                    <input name="id" id="id" type="text" value="<%= set.getString(12)%>" class="validate[required] text-input input-small" size="14"/>
                                </div>
                                    ...
                                    <select id="servicio" name="servicio" class="input-medium">
                                        <%
                                            PreparedStatement ps5 = conn.prepareStatement("SELECT ID,Nombre FROM servicio s, contrato c, cliente cl,"
                                                    + "cliente_natural cn WHERE cn.IDCliente=? AND cn.CLIENTE_idCLIENTE=cl.idCLIENTE AND cl.idCLIENTE=c.CLIENTE_idcliente"
                                ...
                                %>
                                Cant. Extensiones: 
                                <input id="ext" style="height: 30px;" min="0" class="input-small" type="number" name="extensiones" value="<%=cantex%>" />
                                </br>
                                </br>
                                Primer Nombre: 
                                <div class="input-prepend">
                                    <span class="add-on"><i class="icon-user"></i></span>
                                    <input id="pn" name="primer_nombre" type="text" value="<%= set.getString(2)%>" class="validate[required] text-input input-medium" maxlength="20" size="20"/>
                                </div>
                                Segundo Nombre: 
                                <div class="input-prepend">
                                    <span class="add-on"><i class="icon-user"></i></span>
                                    <input id="sn" class="input-medium" name="segundo_nombre" type="text" value="<%= set.getString(3)%>" maxlength="20" size="20" placeholder="Segundo Nombre"/>
                                </div>
                                </br>
                                </br>
                                Primer Apellido:
                                <div class="input-prepend">
                                    <span class="add-on"><i class="icon-user"></i></span>
                                    <input id="pa" name="primer_apellido" type="text" value="<%= set.getString(4)%>" class="validate[required] text-input input-medium" maxlength="20" size="20"/>
                                </div>
                                Segundo Apellido:
                                <div class="input-prepend">
                                    <span class="add-on"><i class="icon-user"></i></span>
                                    <input id="sa" name="segundo_apellido" class="input-medium" type="text" value="<%= set.getString(5)%>" maxlength="20" size="20" placeholder="Segundo Apellido"/>
                                </div>
                                </br>
                                </br>
                                Barrio o Colonia:
                                <div class="input-prepend">
                                    ...
                                    <select id="barriocolonia" name="barriocolonia" class="input-small">
                                        ...
                                        <%}
                                            ...
                                            PreparedStatement ps1 = conn.prepareStatement("SELECT IDBarriocolonia, Abreviacion FROM barriocolonia WHERE Estado=0 AND Cobertura=0 AND IDBarriocolonia!=? "
                                                    + " GROUP BY(Abreviacion)");
                                ...
                                <div class="input-prepend">
                                    <span class="add-on"><i class="icon-pencil"></i></span>
                                    <input id="phone" placeholder="Teléfono" name="telefono" class="input-small" type="tel" value="<%=set.getString(7)%>" size="8" maxlength="8" />
                                </div>
                                Email:
                                <div class="input-prepend">
                                    <span class="add-on"><i class="icon-envelope"></i></span>
                                    <input name="email" id="email" placeholder="Email" class="input-medium" type="email" value="<%=set.getString(8)%>" maxlength="30" size="30"/>
                                </div>
                                </br>
                                </br>
                                Dirección: <textarea id="dir" name="direccion" class="validate[required] text-input" maxlength="100"><%=set.getString(6)%></textarea>
                                Observaciones: <textarea id="obser" name="observaciones" placeholder="Observaciones" maxlength="45" size="45"><%=set.getString(9)%></textarea>
                                </br>
                                </br>
                                <%
                                        }
                        ...
                        <%
                            if (request.getParameter("btn_modificar") != null) {
                                ...
                                try {
                                    ...
                                    PreparedStatement ps = conn.prepareStatement("UPDATE cliente_natural SET "
                                            + "Primer_Nombre = ?, Segundo_Nombre = ?, Primer_Apellido = ?, Segundo_Apellido = ?,"
                                            + " Direccion=?, Telefono=?, Email=?, Observaciones=?, ESTADO_GENERAL_CLIENTE_ID=? WHERE IDCliente=?");
                                    ...
                                    PreparedStatement st2 = conn.prepareStatement("UPDATE contrato c, cliente cl SET Fecha=?, IDBarriocolonia=?, USUARIO_IDUsuario=?, SERVICIO_ID =?, No_Conexiones=? "
                        ...
                        <div class="accordion" id="accordion2">
                            ...
                            <div class="accordion-group">
                                ...
                                <div id="collapseTwo" class="accordion-body collapse">
                                    <div class="accordion-inner">
                                        <div id="contenedor_ordenes">
                                            <table class="tableWithFloatingHeader stock tablesorter">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Fecha</th>
