            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Agregar Nuevo Estado de Orden de Trabajo</p>
                        <div id="fondotabla">
                            <form id="forma" method="POST" onsubmit="return jQuery(this).validationEngine('validate');">
                                <div id="contenedorforma">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="nombre_estado" type="text" maxlength="50" class="validate[required] text-input input-large" placeholder="Nombre del Estado">
                                    </div>
                                    </br>
                                    </br>
                        ...
                        <%
                            ...
                            if (request.getParameter("btn_crear") != null) {
                                try {
                                    ...
                                    PreparedStatement ps = conn.prepareStatement("INSERT INTO estado_orden_trabajo (Nombre, Descripcion, Estado) VALUES(?,?,?)");
                        ...
                        <p id="titulo">Estados de Orden de Trabajo Existentes</p>
                            ...
                            <tbody>
                                <%
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("SELECT * FROM estado_orden_trabajo ORDER BY (Nombre)");
                                        ps.execute();
                                ...
                                <tr>
                                    ...
                                    <td><%=estado%></td>
                                    <td><a href="Modificar Estado Orden Trabajo.jsp?Llave=<%=llave%>&Nombre=<%=nombre%>&Descrip=<%=descripcion%>"></a></td>
                                </tr>
                                <%}
                                        ps.close();
                                        conn.close();
