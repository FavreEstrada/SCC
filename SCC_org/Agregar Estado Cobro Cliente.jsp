            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Agregar Nuevo Estado de Cobro del Cliente</p>
                        <div id="fondotabla">
                            <form id="forma" method="POST" onsubmit="return jQuery(this).validationEngine('validate');">
                                <div id="contenedorforma">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="nombre_estado" type="text" class="validate[required] text-input input-large" maxlength="50" placeholder="Nombre del Estado">
                                    </div>
                                    </br>
                                    </br>
                                    Descripción:<textarea name="descripcion" cols="" rows="" maxlength="50" placeholder="Descripción"></textarea>
                                    </br>   
                                    </br>
                        ...
                        <%
                            ...
                            if (request.getParameter("btn_crear") != null) {
                                try {
                                    ...
                                    PreparedStatement ps = conn.prepareStatement("INSERT INTO estado_cobro (Nombre, Descripcion, Estado) VALUES(?,?,?)");
                        ...
                        <p id="titulo">Estados de Cobro Existentes</p>
                            ...
                            <tbody>
                                <%
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("SELECT * FROM estado_cobro ORDER BY(Nombre)");
                                        ps.execute();
                                ...
                                <tr>
                                    ...
                                    <td><%=estado%></td>
                                    <td><a href ="Modificar Estado Cobro Cliente.jsp?Llave=<%=llave%>&Nombre=<%=nombre%>&Descrip=<%=descripcion%>"></a></td>
                                </tr>
