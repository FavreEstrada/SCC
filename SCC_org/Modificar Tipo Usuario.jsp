...
%>
        ...
        <script>
            function Retornar() {
                location.href = "Agregar Tipo Usuario.jsp";
            }
        </script>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Modificar Tipo de Usuario</p>
                        <div id="fondotabla">
                            <div id="contenedorforma">
                                ...
                                <form id="forma" method="POST" onsubmit="return jQuery(this).validationEngine('validate');">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="nombre_estado" maxlength="20" class="validate[required] text-input input-medium" type="text" value="<%= request.getParameter("Nombre")%>">
                                </div>
                                </br>
                                </br>
                            ...
                            <%
                                if (request.getParameter("btn_modificar") != null) {
                                    ...
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("UPDATE rol SET Nombre=?,Descripcion=?,Estado=? WHERE IDRol=?");
                                        ...
                                        if (ps.execute() == false) {
                                            ...
                                            out.print("<script>location.href = 'Agregar Tipo Usuario.jsp';</script>");
                                        }
                                        ps.close();
                                        conn.close();
                                    } catch (Exception ex) {
