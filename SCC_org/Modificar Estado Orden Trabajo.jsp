...
%>
        ...
        <script>
            ...
            function Retornar() {
                location.href = "Agregar Estado Orden Trabajo.jsp";
            }
        </script>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Modificar Estado Orden de Trabajo</p>
                        <div id="fondotabla">
                            <div id="contenedorforma">
                                ...
                                <form id="forma" method="POST" onsubmit="return jQuery(this).validationEngine('validate');">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="nombre_estado" type="text" class="validate[required] text-input input-large" maxlength="50" value="<%= request.getParameter("Nombre")%>">
                                </div>
                                </br>
                                </br>
                            ...
                            <%
                                if (request.getParameter("btn_modificar") != null) {
                                    ...
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("UPDATE estado_orden_trabajo SET Nombre=?,Descripcion=?,Estado=? WHERE ID=?");
                                        ...
                                        if (ps.execute() == false) {
                                            ...
                                            out.print("<script>location.href = 'Agregar Estado Estado Orden Trabajo.jsp';</script>");
                                        }
                                        ps.close();
                                        conn.close();
                                    } catch (Exception ex) {
