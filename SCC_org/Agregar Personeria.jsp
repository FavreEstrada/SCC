            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Agregar Personería</p>
                        <div id="fondotabla">
                            <form id="forma" method="POST" onsubmit="return jQuery(this).validationEngine('validate');">
                                <div id="contenedorforma">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="tipo" type="text" class="validate[required] text-input" maxlength="45" placeholder="Tipo de Personería">
                                    </div>
                                    </br>
                                    </br>
                                    Descripción:<textarea name="descripcion" cols="" placeholder="Descripción" maxlength="50"></textarea>
                                    </br>   
                                    </br>
                        ...
                        <%
                            ...
                            if (request.getParameter("btn_crear") != null) {
                                try {
                                    ...
                                    PreparedStatement ps = conn.prepareStatement("INSERT INTO personeria (Tipo, Descripcion, Estado) VALUES(?,?,?)");
                                    ...
                                    if (ps.execute() == false) {
                                        out.print("<script>alert('El tipo de personeria fue creada correctamente')</script>");
                                    }
                                    ps.close();
                                    conn.close();
                                } catch (Exception ex) {
                        ...
                        <p id="titulo">Personerias Existentes</p>
                            ...
                            <tbody>
                                <%
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("SELECT * FROM personeria ORDER BY (Tipo)");
                                        ps.execute();
                                ...
                                <tr>
                                    ...
                                    <td><%=estado%></td>
                                    <td><a href ="Modificar Personeria.jsp?Llave=<%=llave%>&Nombre=<%=nombre%>&Descrip=<%=descripcion%>"></a></td>
                                </tr>
