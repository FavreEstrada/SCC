...
%>
        ...
        <script>
            function Retornar() {
                location.href = "Agregar Estado Pago Cliente.jsp";
            }
        </script>
        ...
        <style type="text/css">
            ...
            div#fondotabla{
                ...
                background: rgba(16, 140, 156, 0.3);
                /* For IE 5.5 - 7*/
            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Modificar Estado Pago del Cliente</p>
                        <div id="fondotabla">
                            <div id="contenedorforma">
                                ...
                                <form id="forma" method="POST" onsubmit="return jQuery(this).validationEngine('validate');">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="nombre_estado" class="validate[required] text-input input-large" maxlength="20" type="text" value="<%= request.getParameter("Nombre")%>">
                                </div>
                                </br>
                                </br>
                            ...
                            <%
                                if (request.getParameter("btn_modificar") != null) {
                                    ...
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("UPDATE estado_pago_cliente SET Nombre=?,Descripcion=?,Estado=? WHERE ID=?");
                                        ...
                                        if (ps.execute() == false) {
                                            ...
                                            out.print("<script>location.href = 'Agregar Estado Pago Cliente.jsp';</script>");
                                        }
                                        ps.close();
                                        conn.close();
                                    } catch (Exception ex) {
