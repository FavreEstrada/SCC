...
%>
        ...
        <script>
            function Retornar() {
                location.href = "Agregar Personeria.jsp";
            }
        </script>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <jsp:include page="Menu.jsp" flush="false"></jsp:include>
                        ...
                        <p id="titulo">Modificar Personería</p>
                        <div id="fondotabla">
                            <div id="contenedorforma">
                                ...
                                <form id="forma" method="POST" onsubmit="return jQuery(this).validationEngine('validate');">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="tipo" type="text" value="<%= request.getParameter("Nombre")%>" class="validate[required] text-input input-medium" maxlength="50">
                                </div>
                                </br>
                                </br>
                                Descripción:<textarea name="descripcion" placeholder="Descripción" maxlength="50"><%= request.getParameter("Descrip")%></textarea>
                                </br>   
                                </br>
                            ...
                            <%
                                if (request.getParameter("btn_modificar") != null) {
                                    ...
                                    try {
                                        ...
                                        PreparedStatement ps = conn.prepareStatement("UPDATE personeria SET Tipo=?,Descripcion=?,Estado=? WHERE ID=?");
                                        ...
                                        if (ps.execute() == false) {
                                            out.print("<script>alert('El tipo de personeria fue actualizado')</script>");
                                            out.print("<script>location.href = 'Agregar Personeria.jsp';</script>");
                                        }
                                        ps.close();
                                        conn.close();
                                    } catch (Exception ex) {
